...
export default function Hero() {
  return (
    <div className="px-4 flex flex-col gap-6 container">
      <div className="flex flex-col">
        ...
        <h1 className="text-4xl font-normal text-secondary">
          <span className="text-accent font-bold">PORUČI TORTU</span> OD KOJE ĆE
          GOSTI TRAŽITI JOŠ
        </h1>
      </div>
      <p className="text-sm text-secondary">
        ...
        vestibulum congue pellentesque. Nullam euismod ante porta, blandit odio
        a, tincidunt lectus. Maecenas ultricies justo non faucibus.
      </p>
      <Link
        href="#"
